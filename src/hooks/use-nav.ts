 ...
 *
 * This hook checks permissions, roles, and organization without any server calls.
 * This is perfect for navigation visibility (UX only).
 *
 * Performance:
...
const mockAccessContext = {
  organization: { id: '1', name: 'Main Workspace' },
  user: { id: 'user_123', fullName: 'John Doe' },
...
export function useFilteredNavItems(items: NavItem[]) {
  // Use mock context instead of Clerk
  const accessContext = useMemo(() => mockAccessContext, []);
